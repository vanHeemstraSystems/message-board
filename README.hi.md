...
**NOTE**: संसाधनों के कुशल उपयोग के लिए, हम उपयोग करते हैं**मातहत**के बजाय**डाक में काम करनेवाला मज़दूर**!
...
`threagile-monitoring` is distributed under the terms of the [साथ](https://spdx.org/licenses/MIT.html)लाइसेंस.
